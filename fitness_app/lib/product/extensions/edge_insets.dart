...
extension OnlyPadding on BuildContext {
  ...
  EdgeInsets get minTopBtm => const EdgeInsets.only(top: 20.0, right: 8, left: 8);
...
extension LtrbPadding on BuildContext {
  ...
  EdgeInsets get minLargeLtrb => const EdgeInsets.fromLTRB(16.0, 10.0, 16.0, 5.0);

  EdgeInsets get midLtrb => const EdgeInsets.fromLTRB(20.0, 5.0, 20.0, 20.0);
  EdgeInsets get midLargeLtrb => const EdgeInsets.fromLTRB(25.0, 10.0, 25.0, 10.0);
